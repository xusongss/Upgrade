...
#include <jni.h>
/* Header for class com_ipspiry_barcodeupdate_BarCodeSerialUpdate */

#ifndef _Included_com_ipspiry_barcodeupdate_BarCodeSerialUpdate
#define _Included_com_ipspiry_barcodeupdate_BarCodeSerialUpdate
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_ipspiry_barcodeupdate_BarCodeSerialUpdate
